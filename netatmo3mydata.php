...
echo 'T Therm1: '.$temp_therm1.' '.NAetat($etat_therm1).'\n';
echo 'T Therm1: '.$temp_therm2.' '.NAetat($etat_therm2).'\n';
...
echo 'Bat Therm1: '.NABatteryLevelThermostat($battery_therm1).'\n';
echo 'Bat Therm2: '.NABatteryLevelThermostat($battery_therm2).'\n';
